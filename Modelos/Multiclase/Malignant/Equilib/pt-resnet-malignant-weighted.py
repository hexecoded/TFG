...
# %%
dsets = train_datablock.datasets(TRAIN_DIR)
vocabs = dsets.vocab

# %%
count = Counter(train_malignant.label.to_list())
wgts = [1 / count[vocabs[label]] for img, label in dsets.train]

# %%
train_ds = train_datablock.dataloaders(TRAIN_DIR, batch_size=BATCH_SIZE, num_workers=0, dl_type=WeightedDL, wgts=wgts)
