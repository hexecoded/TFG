...
\begin{document}
	...
	\input{capitulos/03_PreprocesadoDatos}
	
	\input{capitulos/04_AnalisisTecnicas}
	
	\input{capitulos/05_ExtraccionCaracteristicas}
	
	\input{capitulos/06_Deeplearning}
	
    \input{capitulos/07_Diseno}
	
	\input{capitulos/08_Implementación}
	
	\input{capitulos/09_Pruebas}
