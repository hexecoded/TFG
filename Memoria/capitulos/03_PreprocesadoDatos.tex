\chapter{Construcción y preprocesado del conjunto de datos}
...
\begin{multiitem}
	\item \textbf{Nevus}
	\item \textbf{Seborreic keratosis          }  
	 \item \textbf{Actinic keratosis }           
	\item \textbf{Pigmented benign keratosis         }
	\item \textbf{Solar lentigo                           }
	\item \textbf{Dermatofibroma                          
	\item \textbf{Vascular lesion                         }
	\item \textbf{Lichenoid keratosis                     }
	\item \textbf{Acrochordon                             }
	\item \textbf{Lentigo NOS                             }
	\item \textbf{Atypical melanocytic proliferation       }
	\item \textbf{AIMP}                                     }
	\item \textbf{Wart                                     }
	\item \textbf{Angioma                                  }
	\item \textbf{Lentigo simplex                      }   
	\item 	\textbf{Neurofibroma                       }      
	 \item \textbf{Scar }
\end{multiitem}
...
\begin{enumerate}
	...
	\item Recortar la imagen usando el método \textit{findContours()} de OpenCV. Este método binariza la imagen transformándola a blanco y negro, para identificar correctamente los bordes de cada una de las miniaturas en forma de puntos de interés, y devolviendo las coordenadas de sus esquinas en un vector multidimensional. 
...
\section{Uso de GANs de súper resolución}
	...
	\begin{algorithmic}
		...
		\ForEach {path in im\_path}
			...
			\State img = $\matrix     {img}^T * 255$ \Comment{Deshacemos cambios}
			 \State imwrite(f'{im\_out}/' + 'png'.format(base), output)	\Comment{Guardo en disco}
		\EndFor
		\EndProcedure
...
\begin{figure}[H]
		\centering
		\subfigure[Original]{\includegraphics[width=0.3\textwidth]{imagenes/194_13_orig.jpg}} 
		\subfigure[Reescalada]{\includegraphics[width=0.3\textwidth]{imagenes/SEV_194_13.png}} 
