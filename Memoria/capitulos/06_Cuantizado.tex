...
Es decir, el modelo optimizado nos aporta uan ganancia de 1.575, lo cual es proporción es prácticamente la misma ganancia que la conseguda con la cuantización en caso binario. De nuevo, supone aproximadamente un 37\% menos de tiempo de inferencia sobre el modelo original. 
