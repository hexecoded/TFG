...
l\begin{figure}[H]
	\centering
	\subfigure[Fase de congelado]{\includegraphics[width=0.45\textwidth]{imagenes/malignant_freeze.png}} 
	\subfigure[Descongelado]{\includegraphics[width=0.45\textwidth]{imagenes/malignant_unfreeze.png}} 
